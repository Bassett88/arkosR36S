...
If you'd like to access splore to download and update games online while in Pico-8, create a file named zzzsplore.p8 \ 
in /roms/pico-8/carts and launch zzzsplore from the pico-8 system menu in emulationstation \
