...
-  For libretro based cores, you can check the available libretro documentation [here](https://docs.libretro.com/) for more information about various libretro cores.
...
### Nintendo 64
Emulator: (**lr-parallel-n64**) lr-mupen64plus_next lr-mupen64plus [mupen64plus(standalone)](https://github.com/mupen64plus) \
Rom Folder: n64 \
...
### Pico-8
Emulator: [pico8-dyn](https://www.lexaloffle.com/games.php?page=updates) [fake-08](https://github.com/jtothebell/fake-08) Standalone lr-fake08 \
