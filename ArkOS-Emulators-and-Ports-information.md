...
- For the libretro mess emulator: coco.zip coco2.zip coco2b.zip coco3.zip coco3p.zip (must be in the roms/coco3 folder. **NOT THE BIOS FOLDER!**)(See [here](https://wiki.retrobat.org/systems-and-emulators/supported-game-systems/home-computer/trs-80-color-computer#content-of-bios-files) for more info on the content of the bios files.
