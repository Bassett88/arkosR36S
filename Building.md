...
* The mali gpu driver from [here](https://dn.odroid.com/RK3326/ODROID-GO-Advance/rk3326_r13p0_gbm_with_vulkan_and_cl.zip).  Mirror available [here](https://mega.nz/file/aEZGjBSZ#Ip5BZQZs98GDWloqeyrzMgGVN9CFyXrCUKuBmCwSMlg)
  ...
  * For the RG503, use the `libmali-bifrost-g52-g2p0-gbm.so` mali driver from [here](https://github.com/christianhaitian/rk3566Libmali/tree/main/lib)
...
* For the kernel, that is dependent on the device you're targeting:
  ...
  * [Click here for the RK2023 and RGB30](https://github.com/christianhaitian/RG353VKernel/tree/rk2023) - You can build it following the instructions [here](https://github.com/christianhaitian/RG353VKernel/blob/rk2023/README.md).
* For the uboot, that is also dependent on the device you're targeting:
  ...
  * [Click here for the RGB30/RG353V/RK2023](https://github.com/christianhaitian/rk356x-uboot)
...
* For the rk3566 devices (Such as the RG353M/V/VS, RG503, RK2023 and RGB30), [use this version instead](https://github.com/christianhaitian/EmulationStation-fcamod/tree/503noTTS).

The rest I add via scripted updates from here:
* [RG353V](https://github.com/christianhaitian/arkos/blob/main/Update-RG353V.sh)
* [RG353M](https://github.com/christianhaitian/arkos/blob/main/Update-RG353M.sh)
* [RGB30](https://github.com/christianhaitian/arkos/blob/main/Update-RGB30.sh)
* [RG503](https://github.com/christianhaitian/arkos/blob/main/Update-RG503.sh)
* [RK2023](https://github.com/christianhaitian/arkos/blob/main/Update-RK2023.sh)
